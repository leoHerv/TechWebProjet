 ...
 */
final class Version20230331130554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE i23_LineProducts (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_bag INTEGER NOT NULL, id_products_id INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, quantity INTEGER NOT NULL, CONSTRAINT FK_7D291EE68586801B FOREIGN KEY (id_bag) REFERENCES i23_bags (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7D291EE674984C5E FOREIGN KEY (id_products_id) REFERENCES i23_produits (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_7D291EE68586801B ON i23_LineProducts (id_bag)');
        $this->addSql('CREATE INDEX IDX_7D291EE674984C5E ON i23_LineProducts (id_products_id)');
        $this->addSql('CREATE TABLE i23_bags (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quantity INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL)');
