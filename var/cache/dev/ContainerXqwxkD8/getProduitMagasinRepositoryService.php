 ...
 */
class getProduitMagasinRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitMagasinRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitMagasinRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitMagasinRepository.php';

        return $container->privates['App\\Repository\\ProduitMagasinRepository'] = new \App\Repository\ProduitMagasinRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
