...
/* Sandbox/Doctrine/critiqueView1.html.twig */
class __TwigTemplate_ba1c450b35df29f5baf054d9c905db79 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Sandbox/Doctrine/critiqueView1.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "Sandbox/Doctrine/critiqueView1.html.twig"));

        $this->parent = $this->loadTemplate("Sandbox/Layouts/layout4.html.twig", "Sandbox/Doctrine/critiqueView1.html.twig", 1);
    ...
    public function block_titre_principal($context, array $blocks = [])
    {
        ...
        echo "Vue \"critiqueView1\" : exercices Doctrine";
    ...
    <ul>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["critiques"]) || array_key_exists("critiques", $context) ? $context["critiques"] : (function () { throw new RuntimeError('Variable "critiques" does not exist.', 22, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["critique"]) {
            // line 23
            echo "            <li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["critique"], "note", [], "any", false, false, false, 23), "html", null, true);
            echo " : ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["critique"], "avis", [], "any", false, false, false, 23), "html", null, true);
            echo "</li>
        ";
        }
    ...
    ";
        // line 28
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["film"]) || array_key_exists("film", $context) ? $context["film"] : (function () { throw new RuntimeError('Variable "film" does not exist.', 28, $this->source); })()));
        echo "
    ";
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["critiques"]) || array_key_exists("critiques", $context) ? $context["critiques"] : (function () { throw new RuntimeError('Variable "critiques" does not exist.', 29, $this->source); })()));
        echo "
";
    ...
    {
        return "Sandbox/Doctrine/critiqueView1.html.twig";
    }
    ...
    {
        return array (  172 => 29,  168 => 28,  163 => 25,  152 => 23,  148 => 22,  140 => 17,  136 => 16,  132 => 15,  128 => 14,  124 => 13,  120 => 12,  115 => 10,  109 => 8,  99 => 7,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block titre_principal %}Vue \"critiqueView1\" : exercices Doctrine{% endblock %}
...
{% block vue %}
    ...
    {{ dump(critiques) }}
{% endblock %}
", "Sandbox/Doctrine/critiqueView1.html.twig", "C:\\Users\\lhervo01.SFASP2MI\\Documents\\Symfony\\TP6\\l3-web-2022-23-TP5\\templates\\Sandbox\\Doctrine\\critiqueView1.html.twig");
    }
}
