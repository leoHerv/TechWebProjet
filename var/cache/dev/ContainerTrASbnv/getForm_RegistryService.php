...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\MagasinType' => ['privates', 'App\\Form\\MagasinType', 'getMagasinTypeService', true],
            'App\\Form\\ProduitMagasinType' => ['privates', 'App\\Form\\ProduitMagasinType', 'getProduitMagasinTypeService', true],
            'App\\Form\\ProduitPaysType' => ['privates', 'App\\Form\\ProduitPaysType', 'getProduitPaysTypeService', true],
            'App\\Form\\Sandbox\\CritiqueType' => ['privates', 'App\\Form\\Sandbox\\CritiqueType', 'getCritiqueTypeService', true],
            'App\\Form\\Sandbox\\FilmType' => ['privates', 'App\\Form\\Sandbox\\FilmType', 'getFilmTypeService', true],
            'App\\Form\\Sandbox\\NoteType' => ['privates', 'App\\Form\\Sandbox\\NoteType', 'getNoteTypeService', true],
            'App\\Form\\Sandbox\\PersonneType' => ['privates', 'App\\Form\\Sandbox\\PersonneType', 'getPersonneTypeService', true],
            'App\\Form\\Sandbox\\ProfilType' => ['privates', 'App\\Form\\Sandbox\\ProfilType', 'getProfilTypeService', true],
            ...
            'App\\Form\\ProduitMagasinType' => '?',
            'App\\Form\\ProduitPaysType' => '?',
            'App\\Form\\Sandbox\\CritiqueType' => '?',
            'App\\Form\\Sandbox\\FilmType' => '?',
            'App\\Form\\Sandbox\\NoteType' => '?',
            'App\\Form\\Sandbox\\PersonneType' => '?',
            'App\\Form\\Sandbox\\ProfilType' => '?',
